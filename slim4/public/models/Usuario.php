...
class Usuario
{
    ...
    public function crearUsuario()
    {
        ...
        $consulta = $objAccesoDatos->prepararConsulta("INSERT INTO usuarios (username,rol_id,pw,operaciones) VALUES (:username,:rol_id,:pw,:operaciones)");            
    ...
    {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT id, username, rol_id, operaciones FROM usuarios");
        $consulta->execute();
